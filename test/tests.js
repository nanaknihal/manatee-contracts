...
//     const fac = await Factory.attach('0xC334b3465790bC77299D42635B25D77E3e46A78b');
//     const paymentToken = await generateDAI();
//     const bookAddr = await fac.createBeaconProxy('Name of A Book', 'BOOKSYMBOL', 1000000, 15000000, paymentToken.address, false);
//     const book = await Book.attach(bookAddr);
//     console.log(bookAddr, 'BOOK IS AT ADDR');
//     return book;
//
//   } else {
//     const Book = await ethers.getContractFactory('Book');
...
//     const book = await bookFrom.deploy('Name of A Book', 'BOOKSYMBOL', 1000000, 15000000, paymentToken.address, false);
//     await book.deployed();
//     return book;
//   }
// }
...
//   //string memory name_, string memory symbol_, uint supply_, uint price_, address priceToken_, bool resaleEnabled_, address payable manatAddr
//   const paymentToken = await generateUSDT();
//   console.log('PAYMENT TOKEN SHOULD BE ', paymentToken.address);
...
//       await book.connect(owner).setPriceToken('0xdAC17F958D2ee523a2206206994597C13D831ec7');
//       expect(await book.priceToken()).to.equal('0xdAC17F958D2ee523a2206206994597C13D831ec7');
//
...
//       await this.book.setPriceToken(this.genericToken.address);
